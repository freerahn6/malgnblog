# 맑은소프트 블로그 (교육운영 노트)
> 갱신: 2026-07-28 · 28편 발행 · 배포: **자체 웹서버(Rocky 9.5 / Apache 2.4.62 / Resin 4.0.67)** — 코드·문서 준비 완료, 담당자 설치 대기
...
## 지금 진행 중
- 무엇: 총 **28편** 발행 — 10선·5선 계획 사실상 소진, **신규 유입 키워드 발굴 국면 진입**(첫 결과물=AI LMS gl; 07-28). 위캔디오 BOFU는 draft(OTT 진도율 이슈로 비공개 유지) + 자체서버 설치 대기 + 색인 안착 대기
