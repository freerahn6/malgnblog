# 맑은소프트 블로그 (교육운영 노트)
> 갱신: 2026-07-16 · 배포: **자체 웹서버로 이전 예정(2026-07-21 화)** — Netlify/Cloudflare 폐기 결정
...
- 다음 게이트: ① **자체서버 이전(07-21)** ② 캘린더 잔여편 완성 ③ 서치콘솔/네이버 색인 확인
...
## 열린 이슈
- **배포 이전 대기(07-21)** — 그때까지 blog.malgnsoft.com은 Netlify 07-14 옛 빌드로 동결(의도된 방치). 최신본은 자체서버 이전 시 반영
