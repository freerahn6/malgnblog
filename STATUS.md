...
## 지금 진행 중
- 무엇: 총 **29편** 발행 — 10선·5선 계획 소진 후 **신규 발굴 국면**(AI LMS 07-28, 영상보안 07-29). 영상보안은 위캔디오 실검색데이터(바탕화면 `기타` 키워드 csv/xlsx) 근거로 video 클러스터 고volume 빈칸을 메운 것. 위캔디오 OTT+LMS BOFU는 여전히 draft(진도율 이슈) + 자체서버 설치 대기 + 색인 안착 대기
