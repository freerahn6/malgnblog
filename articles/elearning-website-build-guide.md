...
faq:
  - q: "이러닝 홈페이지 제작 비용은 얼마나 드나요?"
    a: "구축 방식에 따라 크게 달라집니다. SaaS형(클라우드 LMS)은 월 수십만 원대 구독료로 시작할 수 있고, LMS 기반 맞춤 구축은 수백만~수천만 원, 완전 자체개발은 그 이상이 들 수 있습니다. 규모·기능 범위·디자인 커스터마이징 정도에 따라 견적이 달라지므로, 필수 기능을 먼저 정리한 뒤 여러 업체에 RFP를 요청해 비교하는 것이 좋습니다."
...
환급과정이나 법정의무교육처럼 규정이 얽힌 교육을 운영한다면 진도율 기록 방식, 본인인증, 부정행위 방지 기능까지 체크해야 합니다. 관련 내용은 <a href="/hrd/refund-training-lms-operation-guide/">환급과정 LMS 운영 가이드</a>에서 더 자세히 다룹니다.
...
보안·인프라가 중요한 공공기관이라면 <a href="/news/csap-lms-trust-assets/">CSAP 인증 LMS</a> 여부도 검토 기준이 됩니다. 클라우드 방식과 설치형의 차이는 <a href="/lms/self-hosted-vs-cloud-lms/">설치형 vs 클라우드 LMS 비교</a>에서 자세히 확인할 수 있습니다.
